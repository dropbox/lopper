 ...
 */
  ...
  #if defined(LOPPER_TARGET_SSE4) || defined(LOPPER_TARGET_NEON)
...
#if defined(LOPPER_TARGET_SSE4) and defined(LOPPER_TARGET_NEON)
  #error "Cannot define vectorization macros for both SSE and NEON"
